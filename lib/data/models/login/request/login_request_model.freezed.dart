...
class _$_LoginRequestModel implements _LoginRequestModel {
  const _$_LoginRequestModel(
      ...
      @JsonKey(name: 'passport_series') required this.passportSeries});
  ...
  @override
  String toString() {
    return 'LoginRequestModel(studentID: $studentID, passportSeries: $passportSeries)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, studentID, passportSeries);
...
abstract class _LoginRequestModel implements LoginRequestModel {
  const factory _LoginRequestModel(
      ...
      @JsonKey(name: 'passport_series')
      required final String passportSeries}) = _$_LoginRequestModel;
